...
public class NotificationService {
    ...
    public void notifySuperAdmins(String summary, String description, boolean sendEmail) {
        userService.getAdmins()
            .stream()
            .filter(admin -> admin.hasRole(GlobalRole.SUPERADMIN))
            .forEach(admin -> notify(admin, summary, description, sendEmail));
    }

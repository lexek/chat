...
<script type="text/ng-template" id="profile.html">
    ...
    <div class="modal-body">
        ...
        <br />
        <br />
        <div ng-if="showRename" class="panel panel-default">
            <form class="panel-body" name="form" ng-submit="doRename(name)">
                ...
                <div class="form-group">
                    <input ng-disabled="form.$invalid" type="submit" class="btn btn-primary btn-modal" value="{{'CONTROLS_CHANGE_NAME' | translate}}"/>
                </div>
            </form>
        </div>
        <div class="btn btn-default btn-modal" ng-click="showPw = !showPw">{{'CONTROLS_CHANGE_PASSWORD' | translate}}</div>
        <br />
        <br />
        <div ng-if="showPw" class="panel panel-default">

                        ...
                        '<div class="rg-range-picker-box well" ng-class="{ \'only-calendars\': !data.hasTimeSliders, \'only-slider\': !data.hasDatePickers }">' +
                            '<div class="rg-range-picker-calendars" ng-show="data.hasDatePickers">' +
                                '<div class="rg-range-picker-calendar-box">' +
                                    ...
                                    '<datepicker ng-model="data.date.from" max-date="data.date.to" min-date="data.date.min" show-weeks="false" class="clean-calendar" starting-day="1"></datepicker>' +
                                '</div>' +
                                '<div class="rg-range-picker-calendar-box right">' +
                                    ...
                                    '<datepicker ng-model="data.date.to" min-date="data.date.from" max-date="data.date.max" show-weeks="false" class="clean-calendar" starting-day="1"></datepicker>' +
                                '</div>' +
                            '</div>' +

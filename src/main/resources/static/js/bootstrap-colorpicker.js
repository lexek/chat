...
angular.module('colorpicker.module', [])
  ...
  .directive('colorpicker', ['$document', '$compile', 'Color', 'helper', function ($document, $compile, Color, helper) {
    return {
      ...
      restrict: 'A',
      scope: {
          close: '&colorpickerCls',
          filter: '&colorpickerFilter'
      },
      link: function ($scope, elem, attrs, ngModel) {
          ...
          template =
            '<div class="colorpicker dropdown">' +
                '<ul class="dropdown-menu">' +
                    ...
                    '<div style="width: 100%">' +
                        '<div class="btn btn-xs btn-danger" ng-click="onClose()" style="width: 50%">cancel</div>' +
                        '<div class="btn btn-xs btn-success" ng-disabled="!checkColor()" ng-click="onOk()" style="width: 50%">ok</div>' +
                    '</div>' +
                '</ul>' +
            '</div>',
        ...
        $scope.checkColor = function() {
            ...
            if (filter) {
                return filter(pickerColor.toRGB());
            } else {
                return true;
            }
        };

var services = angular.module('chat.services', ["ngCookies", "chat.messageProcessing", "chat.services.settings", "chat.services.notifications"]);
...
services.service("chatService", ["$modal", "chatSettings", "$translate", "$http", "$timeout", "notificationService", "messageProcessingService", function($modal, settings, $translate, $http, $timeout, notificationService, msgs) {
